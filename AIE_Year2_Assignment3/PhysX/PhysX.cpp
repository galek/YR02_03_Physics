...
// Timestep for everything to follow
#define TIMESTEP 60.0f

// DEBUG DEFINES
// Shall we use a fixed render loop?
#define _USETIMESTEP

// We can permanently disable parts of the scene here.
// F keys can be pressed to only show certian parts.
#define _WALLS
#define _SHOOT		// F10
#define _LINKED		// F9
#define _RAGDOLL	// F8
#define _WATER		// F7
#define _PARTICLES	// F6
#define _CLOTH		// F5
//		ALL			// F4
// MACROS
